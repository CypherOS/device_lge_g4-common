...
# Display
PRODUCT_PACKAGES += \
    vendor.aoscp.displayengine@1.0 \
    vendor.aoscp.touch@1.0 \
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/configs/android.hardware.camera.flash-autofocus.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.camera.flash-autofocus.xml \
