 ...
 */
#define RECOMMENDED_ANALYSIS_VIDEO_WIDTH 427
#define RECOMMENDED_ANALYSIS_VIDEO_HEIGHT 240
 ...
 *   @input_dim: dimension of the input buffer
 ...
 *   @initial_frame_no_skip_cnt: nitial number of frame which
