...
static int32_t module_paaf_update_meta(imgbase_client_t *p_client,
  img_meta_t *p_meta);
static boolean module_paaf_handle_set_stream_config(mct_event_module_t
  *p_mod_event, imgbase_client_t *p_client, img_core_ops_t *p_core_ops);
static boolean module_paaf_handle_af_config(mct_event_module_t *p_mod_event,
  imgbase_client_t *p_client, img_core_ops_t *p_core_ops);
static boolean module_paaf_handle_stream_crop_event(mct_event_module_t
  *p_mod_event, imgbase_client_t *p_client, img_core_ops_t *p_core_ops);
static boolean module_paaf_handle_af_tune_ptr_event(mct_event_module_t
  *p_mod_event, imgbase_client_t *p_client, img_core_ops_t *p_core_ops);
 ...
 * Notes: none
 **/
boolean module_paaf_query_mod(mct_pipeline_cap_t *p_mct_cap, void* p_mod)
{
  ...
  if (p_sensor_cap->color_arrangement == CAM_FILTER_ARRANGEMENT_Y) {
    p_analysis_info->analysis_max_res.width = PAAF_RECOMMENDED_ANALYSIS_WIDTH;
    p_analysis_info->analysis_max_res.height =  PAAF_RECOMMENDED_ANALYSIS_HEIGHT;
    ...
    p_analysis_info->analysis_padding_info.min_stride = PAAF_RECOMMENDED_ANALYSIS_WIDTH;
    p_analysis_info->analysis_padding_info.min_scanline = PAAF_RECOMMENDED_ANALYSIS_HEIGHT;
 ...
 * Notes: none
 **/
boolean module_paaf_handle_stream_crop_event(mct_event_module_t
  *p_mod_event, imgbase_client_t *p_client, img_core_ops_t *p_core_ops)
{
  img_paaf_client_t *p_paaf_client;
  ...
  *p_ctrl_parm, imgbase_client_t *p_client, img_core_ops_t *p_core_ops)
{
  ...
  if (current_chosen_cnt) {
    ...
    if (meta_stream_info->num_streams > 0) {
      IDBG_ERROR("PAAf not enabled on any streams");
    }
  }
 ...
 * Notes: none
 **/
boolean module_paaf_handle_af_tune_ptr_event(mct_event_module_t
  *p_mod_event, imgbase_client_t *p_client, img_core_ops_t *p_core_ops)
{
  img_paaf_client_t *p_paaf_client;
 ...
 * Notes: none
 **/
boolean module_paaf_handle_af_config(mct_event_module_t *p_mod_event,
  imgbase_client_t *p_client, img_core_ops_t *p_core_ops)
{
  img_paaf_client_t *p_paaf_client;
  img_paaf_session_data_t *p_session_data;
 ...
 * Notes: none
 **/
boolean module_paaf_handle_set_stream_config(mct_event_module_t
  *p_mod_event, imgbase_client_t *p_client, img_core_ops_t *p_core_ops)
{
  module_imgbase_t *p_mod;
