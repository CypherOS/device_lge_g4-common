...
typedef chromatix_manual_white_balance_type awb_rgb_gains_type;

typedef chromatix_awb_gain_adj_type awb_gain_adjust_type;

typedef chromatix_color_correction_type awb_ccm_test_output_type;
...
typedef struct
{
  ...
  const awb_algo_struct_type*                   tuning_params;              /**< Bayer AWB tuning parameters. */
