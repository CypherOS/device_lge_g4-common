...
#define AF_TOF_MAX_DISTANCE_ENTRIES (5)               /**< Maximum number of TOF entries. */
...
typedef struct
{
    af_algo_tune_parms_t* ptr;                         /**< Pointer to AF core algorithm tuning header */
...
/**
* Structure defining face extension tuning
* Note: This structure is to be moved to chromatix in the next
* chromatix revision.
*/
...
typedef struct
{
    ...
    float                 af_sensitiviy;
    int                   af_actuator_shift_comp;
    int                   af_actuator_hysteresis_comp;
...
typedef struct {
    ...
    uint32 haf_debug_size;                  /**< HAF debug data size */
    uint32 tof_debug_size;                  /**< TOF debug data size */
    uint32 dciaf_debug_size;                /**< DCIAF debug data size */
    uint32 pdaf_debug_size;                 /**< PDAF debug data size */
    char *stats_buffer;                     /**< AF stats array pointer */
    uint32 stats_buffer_size;               /**< AF stats debug size */
} af_debug_t;
...
typedef struct
{
    ...
    af_algo_tune_parms_t*              tuning_info;        /**< AF algorithm tuning parameters */
...
typedef struct
{
    af_algo_tune_parms_t*   algo_tuning_info;         /**< Algo tuning info pointer */
