...
static boolean af_cmixer_set_parameters(af_alg_interface_t *p_alg, af_haf_set_parameter_t *param);
static boolean af_cmixer_set_inputs (af_alg_interface_t *p_alg, af_haf_set_parameter_t *param);
static boolean af_cmixer_set_tuning(af_alg_interface_t *p_alg, af_haf_tune_params_t *haf_tuning);
...
static boolean af_cmixer_process_monitor(af_alg_interface_t *p_alg, af_haf_monitor_data_t *output, int cur_pos);
static boolean af_cmixer_process_search(af_alg_interface_t *p_alg, af_haf_focus_search_data_t *output, int cur_pos);
...
*
*@p_alg : af_alg_interface pointer.
*@haf_tuning : af_algo_tune_parms_t pointer.
*Return: boolean
**/
