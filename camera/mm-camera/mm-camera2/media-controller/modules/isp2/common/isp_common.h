...
typedef enum {
  ISP_MODULE_EVENT_SET_STREAM_CONFIG               = 0,
  ISP_MODULE_EVENT_SET_STREAM_CONFIG_FOR_FLASH     = 1,
  ISP_MODULE_EVENT_SET_CHROMATIX_PTR               = 2,
  ISP_MODULE_EVENT_SET_FLASH_MODE                  = 3,
  ISP_MODULE_EVENT_STATS_AEC_UPDATE                = 4,
  ISP_MODULE_EVENT_STATS_AWB_UPDATE                = 5,
  ISP_MODULE_EVENT_STATS_ASD_UPDATE                = 6,
  ISP_MODULE_EVENT_STATS_UPDATE                    = 7,
  ISP_MODULE_EVENT_STATS_DIS_UPDATE                = 8,
  ISP_MODULE_EVENT_STATS_AEC_CONFIG_UPDATE         = 9,
  ISP_MODULE_EVENT_STATS_AWB_CONFIG_UPDATE         = 10,
  ISP_MODULE_EVENT_STATS_AF_CONFIG_UPDATE          = 11,
  ISP_MODULE_EVENT_STATS_RS_CONFIG_UPDATE          = 12,
  ISP_MODULE_EVENT_SET_DIGITAL_GAIN                = 13,
  ISP_MODULE_EVENT_GET_ISP_TABLES                  = 14,
  ISP_MODULE_EVENT_SET_FAST_AEC_CONVERGE_MODE      = 15,
  ISP_MODULE_EVENT_ISP_PRIVATE_EVENT               = 16,
  ISP_MODULE_EVENT_SET_AF_ROLLOFF_PARAMS           = 17,
  ISP_MODULE_EVENT_SENSOR_LENS_POSITION_UPDATE     = 18,
  ISP_MODULE_EVENT_LA_ALGO_UPDATE                  = 19,
  ISP_MODULE_EVENT_LTM_ALGO_UPDATE                 = 20,
  ISP_MODULE_EVENT_CDS_REQUEST                     = 21,
  ISP_MODULE_EVENT_GTM_ALGO_UPDATE                 = 22,
  ISP_MODULE_EVENT_MANUAL_AWB_UPDATE               = 23,
  ISP_MODULE_EVENT_TINTLESS_ALGO_UPDATE            = 24,
  ISP_MODULE_EVENT_OFFLINE_CONFIG_OVERWRITE        = 25,
  ISP_MODULE_EVENT_STATS_AF_UPDATE                 = 26,
  ISP_MODULE_EVENT_SET_DEFECTIVE_PIXELS            = 27,
  ISP_MODULE_EVENT_REQUEST_STATS_TYPE              = 28,
  ISP_MODULE_EVENT_MAX                             = 29,
 ...
 **/
typedef struct {
  uint32_t min_overlap_half;
  uint32_t max_stripe_offset;
  uint32_t min_left_split;
  uint32_t smallest_split_point;
