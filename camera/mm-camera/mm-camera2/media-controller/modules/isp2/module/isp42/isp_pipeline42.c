...
static boolean isp_pipeline42_udpate_module_cfg(int32_t fd,
...
static isp_pipeline_stats_func_table_t func_table = {
  ...
  .pipeline_udpate_module_cfg = isp_pipeline42_udpate_module_cfg,
...
/** isp_pipeline42_udpate_module_cfg:
 *
 *  @fd: file descriptor
...
isp_pipeline_t *isp_pipeline42_open(uint32_t isp_version, uint32_t isp_id)
{
  ...
  if ((isp_version == ISP_MSM8937) || (isp_version == ISP_MSM8917)) {
    ...
    curr_pipeline->is_camif_crop_supported = TRUE;
