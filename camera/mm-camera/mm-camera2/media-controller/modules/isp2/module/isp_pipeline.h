 ...
 *  @pipeline_udpate_module_cfg: update module cfg register
 **/
typedef struct {
  ...
  boolean (*pipeline_fill_stats_info)(uint32_t, iface_resource_request_t *,
    uint32_t, boolean, uint32_t);
  boolean (*pipeline_calculate_roi_map)(isp_zoom_params_t *,
    mct_bus_msg_stream_crop_t *, uint32_t);
  boolean (*pipeline_udpate_module_cfg)(int32_t, uint8_t *, isp_module_enable_info_t *);
