  ...
  isp_sub_module_t *isp_sub_module, mct_event_t *event)
{
  ...
  case CAM_INTF_META_MODE:
    isp_sub_module->manual_ctrls.app_ctrl_mode = *((uint8_t *)set_param->parm_data);
    break;
  ...
  isp_sub_module_t *isp_sub_module, mct_event_t *event)
{
  ...
  private_func = isp_sub_module_priv->private_func;
  ISP_ERR("param->num_of_parm_events %d", param->num_of_parm_events);
  ...
  isp_sub_module_t *isp_sub_module, mct_event_t *event)
{
  ...
  case MCT_EVENT_MODULE_SET_STREAM_CONFIG:
    int_event = ISP_MODULE_EVENT_SET_STREAM_CONFIG;
    break;

  case MCT_EVENT_MODULE_ISP_CDS_REQUEST:
     int_event = ISP_MODULE_EVENT_CDS_REQUEST;
     break;

  case MCT_EVENT_MODULE_SET_STREAM_CONFIG_FOR_FLASH:
    int_event = ISP_MODULE_EVENT_SET_STREAM_CONFIG_FOR_FLASH;
    break;

  case MCT_EVENT_MODULE_SET_FLASH_MODE:
    int_event = ISP_MODULE_EVENT_SET_FLASH_MODE;
    break;

  case MCT_EVENT_MODULE_STATS_ASD_UPDATE:
    int_event = ISP_MODULE_EVENT_STATS_ASD_UPDATE;
    break;

  case MCT_EVENT_MODULE_ISP_LA_ALGO_UPDATE:
    int_event = ISP_MODULE_EVENT_LA_ALGO_UPDATE;
    break;

  case MCT_EVENT_MODULE_ISP_LTM_ALGO_UPDATE:
    int_event = ISP_MODULE_EVENT_LTM_ALGO_UPDATE;
    break;

  case MCT_EVENT_MODULE_ISP_GTM_ALGO_UPDATE:
    int_event = ISP_MODULE_EVENT_GTM_ALGO_UPDATE;
    break;

  case MCT_EVENT_MODULE_STATS_UPDATE:
    int_event = ISP_MODULE_EVENT_STATS_UPDATE;
    break;

  case MCT_EVENT_MODULE_STATS_DIS_UPDATE:
    int_event = ISP_MODULE_EVENT_STATS_DIS_UPDATE;
    break;

  case MCT_EVENT_MODULE_STATS_AEC_CONFIG_UPDATE:
    int_event = ISP_MODULE_EVENT_STATS_AEC_CONFIG_UPDATE;
    break;

  case MCT_EVENT_MODULE_STATS_AWB_CONFIG_UPDATE:
    int_event = ISP_MODULE_EVENT_STATS_AWB_CONFIG_UPDATE;
    break;

  case MCT_EVENT_MODULE_STATS_AF_CONFIG_UPDATE:
    int_event = ISP_MODULE_EVENT_STATS_AF_CONFIG_UPDATE;
    break;

  case MCT_EVENT_MODULE_STATS_RS_CONFIG_UPDATE:
    int_event = ISP_MODULE_EVENT_STATS_RS_CONFIG_UPDATE;
    break;

  case MCT_EVENT_MODULE_SET_DIGITAL_GAIN:
    int_event = ISP_MODULE_EVENT_SET_DIGITAL_GAIN;
    break;

  case MCT_EVENT_MODULE_STATS_AWB_MANUAL_UPDATE:
    int_event = ISP_MODULE_EVENT_MANUAL_AWB_UPDATE;
    break;
  case MCT_EVENT_MODULE_GET_ISP_TABLES:
    int_event = ISP_MODULE_EVENT_GET_ISP_TABLES;
    break;

  case MCT_EVENT_MODULE_SET_FAST_AEC_CONVERGE_MODE:
    int_event = ISP_MODULE_EVENT_SET_FAST_AEC_CONVERGE_MODE;
    break;

  case MCT_EVENT_MODULE_SET_CHROMATIX_PTR:
  case MCT_EVENT_MODULE_SET_RELOAD_CHROMATIX:
    int_event = ISP_MODULE_EVENT_SET_CHROMATIX_PTR;
    break;

  case MCT_EVENT_MODULE_STATS_AEC_UPDATE:
    int_event = ISP_MODULE_EVENT_STATS_AEC_UPDATE;
    break;

  case MCT_EVENT_MODULE_STATS_AWB_UPDATE:
    int_event = ISP_MODULE_EVENT_STATS_AWB_UPDATE;
    break;
  ...
  case MCT_EVENT_MODULE_SET_AF_ROLLOFF_PARAMS:
    int_event = ISP_MODULE_EVENT_SET_AF_ROLLOFF_PARAMS;
    break;

  case MCT_EVENT_MODULE_SENSOR_LENS_POSITION_UPDATE:
    int_event = ISP_MODULE_EVENT_SENSOR_LENS_POSITION_UPDATE;
    break;

  case MCT_EVENT_MODULE_ISP_TINTLESS_ALGO_UPDATE:
    int_event = ISP_MODULE_EVENT_TINTLESS_ALGO_UPDATE;
    break;

  case MCT_EVENT_MODULE_ISP_OFFLINE_CONFIG_OVERWRITE:
    /*offline reprocessing implementation pending
      define the interface and event first*/
    int_event = ISP_MODULE_EVENT_OFFLINE_CONFIG_OVERWRITE;
    break;

  case MCT_EVENT_MODULE_SET_DEFECTIVE_PIXELS:
    int_event = ISP_MODULE_EVENT_SET_DEFECTIVE_PIXELS;
    break;

  case MCT_EVENT_MODULE_REQUEST_STATS_TYPE:
    int_event = ISP_MODULE_EVENT_REQUEST_STATS_TYPE;
    break;
...
static boolean isp_sub_module_port_event(mct_port_t *port, mct_event_t *event)
{
  ...
  ret = isp_sub_module_util_get_stream_info(isp_sub_module, event->identity,
    &stream_info);
  if ((ret == FALSE) || !stream_info) {
    ISP_ERR("failed: isp_sub_module_util_get_stream_info %s %d %p",
      MCT_MODULE_NAME(module), ret, stream_info);
    goto ERROR;
  }
