 ...
 *  Return TRUE on success and FALSE on failure
 **/
static boolean chroma_enhan_apply_bestshot(mct_module_t *module,
  ...
  isp_sub_module_t *isp_sub_module, mct_event_t *event)
{
  ...
  case CAM_WB_MODE_INCANDESCENT: {
    mod->cv_data = chromatix_CV_ptr->A_color_conversion;
  }
    break;
 ...
 * Return TRUE on success and FALSE on failure
 **/
static boolean chroma_enhan_apply_spl_effect(mct_module_t *module,
 ...
 *
 **/
static void chroma_enhan_interpolate(
...
{
  float ratio = 0.0;
  chromatix_color_conversion_type *cv_table_H, *cv_table_D50,
  ...
  cv_table_H = &chromatix_CV_ptr->H_color_conversion;
  ...
  cv_table_D50 = &chromatix_CV_ptr->D50_color_conversion;
  ...
  case AWB_CCT_TYPE_A_H: {
    ...
    chroma_enhan_interpolate(cv_table_A, cv_table_H, &mod->cv_data,
      ratio);
  }
    break;
  ...
  case AWB_CCT_TYPE_D50_TL84: {
    ...
    chroma_enhan_interpolate(cv_table_D50, cv_table_TL84, &mod->cv_data, ratio);
  }
    break;
