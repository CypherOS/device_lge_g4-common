 ...
 *  Return TRUE
 **/
static boolean port_fovcrop46_handle_cds_request(mct_module_t *module,
  fovcrop46_t *fovcrop, mct_event_t *event)
{
  boolean             ret = TRUE;
 ...
 *  Return TRUE
 **/
static boolean port_fovcrop46_handle_hal_set_parm(mct_module_t *module,
  ...
  mct_event_t *event)
{
  ...
  case MCT_EVENT_MODULE_ISP_PRIVATE_EVENT: {
    ...
    default:
      ret = fovcrop46_handle_isp_private_event(fovcrop,
