...
#define DEMOSAIC40_VERSION "47"

#define DEMOSAIC40_MODULE_NAME(n) \
  "demosaic"n

static isp_sub_module_private_func_t demosaic47_private_func = {
  .isp_sub_module_init_data              = demosaic47_init,
  .isp_sub_module_destroy                = demosaic47_destroy,

  .control_event_handler = {
    [ISP_CONTROL_EVENT_STREAMON]         = demosaic47_streamon,
    [ISP_CONTROL_EVENT_STREAMOFF]        = demosaic47_streamoff,
    [ISP_CONTROL_EVENT_SET_PARM]         = isp_sub_module_port_set_param,
  },

  .module_event_handler = {
    [ISP_MODULE_EVENT_SET_CHROMATIX_PTR] = demosaic47_set_chromatix_ptr,
    [ISP_MODULE_EVENT_STATS_AEC_UPDATE]  = demosaic47_stats_aec_update,
    [ISP_MODULE_EVENT_STATS_AWB_UPDATE]  = demosaic47_stats_awb_update,
    [ISP_MODULE_EVENT_MANUAL_AWB_UPDATE] = demosaic47_stats_awb_update,
    [ISP_MODULE_EVENT_ISP_PRIVATE_EVENT] =
      isp_sub_module_port_isp_private_event,
  },

  .isp_private_event_handler = {
    [ISP_PRIVATE_GET_VFE_DIAG_INFO_USER] = demosaic47_get_vfe_diag_info_user,
    [ISP_PRIVATE_SET_MOD_ENABLE]         = isp_sub_module_port_enable,
    [ISP_PRIVATE_SET_TRIGGER_ENABLE]     = isp_sub_module_port_trigger_enable,
    [ISP_PRIVATE_ACTION_RESET]           = demosaic47_reset,
    [ISP_PRIVATE_SET_TRIGGER_UPDATE]     = demosaic47_trigger_update,
  },
  ...
  .set_param_handler = {
    ...
    [ISP_SET_PARM_SENSOR_HDR_MODE] = isp_set_hdr_mode,
  },
};

/** module_demosaic47_init:
 *
 *  @name: name of ISP module - "demosaic47"
 *
 ...
 **/
static mct_module_t *module_demosaic47_init(const char *name)
{
  boolean                ret = TRUE;
  ...
  module = isp_sub_module_init(name, NUM_SINK_PORTS, NUM_SOURCE_PORTS_DEMOSAIC,
    &demosaic47_private_func, ISP_MOD_DEMOSAIC, "demosaic",
    ISP_LOG_DEMOSAIC);
 ...
 *  Returns: void
 **/
static void module_demosaic47_deinit(mct_module_t *module)
{
  if (!module) {
...
static isp_submod_init_table_t submod_init_table = {
  .module_init = module_demosaic47_init,
  .module_deinit = module_demosaic47_deinit,
};
