  ...
  void *data)
{
  ...
  bg_config->r_Max = (255 - 16) << ISP_STATS_BITS_DIFF;
  bg_config->gr_Max = (255 - 16) << ISP_STATS_BITS_DIFF;
  bg_config->b_Max = (255 - 16) << ISP_STATS_BITS_DIFF;
  bg_config->gb_Max = (255 - 16) << ISP_STATS_BITS_DIFF;
