...
#define ABF40_VERSION "40"

#define ABF_MODULE_NAME(n) \
  "abf"n

static boolean module_abf40_init_data(mct_module_t *module,
  isp_sub_module_t *isp_sub_module);
static void module_abf40_destroy(mct_module_t *module,
  isp_sub_module_t *isp_sub_module);
static boolean module_abf40_streamoff(mct_module_t *module,
  isp_sub_module_t *isp_sub_module, mct_event_t *event);
static boolean module_abf40_set_chromatix_ptr(mct_module_t *module,
  isp_sub_module_t *isp_sub_module, mct_event_t *event);
static boolean module_abf40_aec_update(mct_module_t *module,
  isp_sub_module_t *isp_sub_module, mct_event_t *event);
static boolean module_abf40_trigger_update(mct_module_t *module,
  isp_sub_module_t *isp_sub_module, mct_event_t *event);


static isp_sub_module_private_func_t abf40_private_func = {
  .isp_sub_module_init_data              = module_abf40_init_data,
  .isp_sub_module_destroy                = module_abf40_destroy,

  .control_event_handler = {
    [ISP_CONTROL_EVENT_STREAMON]         = isp_sub_module_port_streamon,
    [ISP_CONTROL_EVENT_STREAMOFF]        = module_abf40_streamoff,
    [ISP_CONTROL_EVENT_SET_PARM]         = isp_sub_module_port_set_param,
  },

  .module_event_handler = {
    [ISP_MODULE_EVENT_SET_CHROMATIX_PTR] =
      module_abf40_set_chromatix_ptr,
    [ISP_MODULE_EVENT_STATS_AEC_UPDATE]  =
      module_abf40_aec_update,
  ...
  .isp_private_event_handler = {
    ...
    [ISP_PRIVATE_SET_TRIGGER_UPDATE]     = module_abf40_trigger_update,
  },
...
static boolean module_abf40_init_data(mct_module_t *module,
  isp_sub_module_t *isp_sub_module)
{
  return abf40_init(isp_sub_module);
}

/** module_abf40_destroy:
 *
 *  @module: mct module handle
 *  @isp_sub_module: isp sub module handle
 *
...
static void module_abf40_destroy(mct_module_t *module,
  isp_sub_module_t *isp_sub_module)
{
   abf40_destroy(isp_sub_module);
}

/** module_abf40_stats_aec_update:
 *
 * @mod: demosaic module
  ...
  isp_sub_module_t *isp_sub_module, mct_event_t *event)
{
  ...
  return abf40_aec_update(isp_sub_module,
    event->u.module_event.module_event_data);
}

/** module_abf40_streamoff:
 *
 *  @module: mct module handle
 *  @isp_sub_module: isp sub module handle
  ...
  isp_sub_module_t *isp_sub_module, mct_event_t *event)
{
  ...
  return abf40_streamoff(isp_sub_module,
    event->u.module_event.module_event_data);
}
  ...
  isp_sub_module_t *isp_sub_module, mct_event_t *event)
{
  ...
  return abf40_set_chromatix_ptr(isp_sub_module,
    event->u.module_event.module_event_data);
}

/** module_abf40_trigger_update:
 *
 *  @module: mct module handle
 *  @isp_sub_module: isp sub module handle
 *  @event: mct event handle
  ...
  isp_sub_module_t *isp_sub_module, mct_event_t *event)
{
  ...
  return abf40_trigger_update(isp_sub_module,
    event->u.module_event.module_event_data);
}
 ...
 **/
static mct_module_t *module_abf40_init(const char *name)
{
  boolean                ret = TRUE;
  ...
  if (strncmp(name, ABF_MODULE_NAME(ABF40_VERSION),
      strlen(name))) {
    ISP_ERR("failed: invalid name %s expected %s", name,
      ABF_MODULE_NAME(ABF40_VERSION));
    return NULL;
  }

  module = isp_sub_module_init(name, NUM_SINK_PORTS, NUM_SOURCE_PORTS,
    &abf40_private_func, ISP_MOD_ABF, "abf", ISP_LOG_ABF);
 ...
 *  Returns: void
 **/
static void module_abf40_deinit(mct_module_t *module)
{
  if (!module) {
...
static isp_submod_init_table_t submod_init_table = {
  .module_init = module_abf40_init,
  .module_deinit = module_abf40_deinit,
};
