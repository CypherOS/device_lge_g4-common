 ...
 *  Return TRUE
 **/
static boolean port_scaler44_handle_cds_request(scaler44_t *scaler,
  mct_event_t *event)
{
  boolean ret = TRUE;
 ...
 *  Return TRUE
 **/
static boolean port_scaler44_handle_hal_set_parm(mct_module_t *module,
  ...
  mct_event_t *event)
{
  ...
  case MCT_EVENT_MODULE_ISP_PRIVATE_EVENT:
    ret = scaler44_handle_isp_private_event(scaler,
