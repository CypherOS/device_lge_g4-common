  ...
  isp_stripe_request_t *stripe_request_info)
{
  ...
  stripe_offset = split_point - limits->min_overlap_half;
  ...
  stripe_request_info->ispif_out_info.overlap =
    FLOOR2(split_point + limits->min_overlap_half - stripe_offset);
 ...
 *  Return TRUE on success and FALSE on failure
 **/
boolean scaler44_handle_isp_private_event(scaler44_t *scaler,
