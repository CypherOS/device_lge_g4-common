...
static boolean module_linearization40_stats_aec_update(mct_module_t *module,
  isp_sub_module_t *isp_sub_module, mct_event_t *event);
static boolean module_linearization40_stats_awb_update(mct_module_t *module,
  isp_sub_module_t *isp_sub_module, mct_event_t *event);
...
static isp_sub_module_private_func_t linearization40_private_func = {
  ...
  .module_event_handler = {
    ...
    [ISP_MODULE_EVENT_STATS_AWB_UPDATE]  =
      module_linearization40_stats_awb_update,
  ...
  .set_param_handler = {
    ...
    [ISP_SET_PARM_SENSOR_HDR_MODE]      = linearization40_set_hdr_mode,
  },
};
  ...
  isp_sub_module_t *isp_sub_module, mct_event_t *event)
{
  ...
  return linearization40_stats_awb_update(isp_sub_module,
    event->u.module_event.module_event_data);
}
    ...
    mct_event_t      *event)
{
  ...
  ISP_DBG("PEDESTAL enable %d", submod_enable[ISP_MOD_PEDESTAL]);
  linearization->pedestal_enable = submod_enable[ISP_MOD_PEDESTAL];
