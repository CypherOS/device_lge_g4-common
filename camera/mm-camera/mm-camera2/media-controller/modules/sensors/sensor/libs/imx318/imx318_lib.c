  ...
  unsigned short *p_x_end, unsigned short *p_y_end)
{
  ...
  PdLibPoint_t ret_p1 = {0};
  PdLibPoint_t ret_p2 = {0};
...
int32_t imx318_pdaf_calculate_defocus
  (__attribute__((unused))void * arg1, void * arg2,
   signed long (*get_defocus)(void *input, void *output))
{
  ...
  static PdLibSensorRegData_t    regdata = {0};
  static PdLibSensorSetting_t    settings = {0};
