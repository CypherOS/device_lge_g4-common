...
const uint32_t pick_v1[SEN_COND_MAX][SEN_USECASE_MAX] = {
   ...
   *  pick_v1[0][4] = 0.
   */
  /*FAST AEC   HFR    IHDR   RHDR VHDR Snapshot  Video/P *//*check for if 1*/
  {    1,      1,    0,    0,   1,     0,      1,  }, /* FPS*/
  {    0,      1,    0,    0,   0,     0,      0,  }, /* Bounded FPS*/
  {    0,      0,    1,    1,   0,     1,      1,  }, /* Aspect ratio*/
  {    0,      0,    1,    1,   1,     1,      1,  }, /* Resolution w*/
  {    0,      0,    1,    1,   0,     1,      1,  }, /* Resolution h*/
  {    1,      1,    1,    1,   1,     1,      1,  }, /* Mode Pix Clock */
  {    0,      1,    0,    0,   0,     0,      0,  }, /* mod HFR*/
  {    0,      0,    0,    0,   0,     1,      1,  }, /* mod DEF*/
  {    0,      0,    1,    0,   1,     0,      0,  }, /* mod IHDR*/
  {    0,      0,    0,    1,   0,     0,      0,  }, /* mod RHDR*/
  {    1,      1,    0,    0,   1,     1,      0,  }, /* mod Max Resolution*/
  {    0,      0,    1,    1,   0,     0,      1,  }, /* mod Best Resolution*/
};
...
{
  SLOW("check mode: %d", (pick_data->in_mode == pick_data->ex_mode));
