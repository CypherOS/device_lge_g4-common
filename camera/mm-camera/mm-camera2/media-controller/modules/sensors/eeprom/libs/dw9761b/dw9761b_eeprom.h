      ...
      {
        {
          ...
          .mem_settings =
          {
            { 0x400, CAMERA_I2C_WORD_ADDR,
              2332, CAMERA_I2C_BYTE_DATA, CAMERA_I2C_OP_READ, 0 },
            { 0x0F10, CAMERA_I2C_WORD_ADDR,
              3, CAMERA_I2C_BYTE_DATA, CAMERA_I2C_OP_READ, 0 },
          },
          .memory_map_size = 2,
#else
          .mem_settings =
          {
            ...
            /* read extra byte for mimicking H/L flag */
            { 0x0F10, CAMERA_I2C_WORD_ADDR,
              1, CAMERA_I2C_BYTE_DATA, CAMERA_I2C_OP_READ, 0 },
            { 0x0F10, CAMERA_I2C_WORD_ADDR,
              1, CAMERA_I2C_BYTE_DATA, CAMERA_I2C_OP_READ, 0 },
            { 0x0F13, CAMERA_I2C_WORD_ADDR,
              1, CAMERA_I2C_BYTE_DATA, CAMERA_I2C_OP_READ, 0 },
          },
          .memory_map_size = 5,
#endif
