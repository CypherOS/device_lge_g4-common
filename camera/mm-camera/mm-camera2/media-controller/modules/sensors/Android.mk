...
ifeq ($(call is-board-platform-in-list,msm8974 msm8960 msm7627a msm8660 msm8916 msm8226 msm8952 msm8610 apq8084 msm8994 msm8996 msm8992 msm8937 msm8953),true)
...
ifeq ($(LOCAL_PROPRIETARY_MODULE), true)
  ifeq ($(LOCAL_32_BIT_ONLY), true)
    LOCAL_CFLAGS += -DMOD_SENSOR_LIB_PATH=\"/vendor/lib\"
  else
    LOCAL_CFLAGS += -DMOD_SENSOR_LIB_PATH=\"/vendor/lib64\"
  endif
else
 ifeq ($(LOCAL_32_BIT_ONLY), true)
  LOCAL_CFLAGS += -DMOD_SENSOR_LIB_PATH=\"/system/lib\"
 else
  LOCAL_CFLAGS += -DMOD_SENSOR_LIB_PATH=\"/system/lib64\"
 endif
endif
