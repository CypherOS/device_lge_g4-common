...
/** cpp_bf_rnr_bilat_t:
 *
 *   @weight1_rnr_disable: flag to enable/disable rnr weight
 *
 *   RNR bilateral information
 **/
typedef struct {
  uint32_t weight1_rnr_disable;
} cpp_bf_rnr_bilat_t;
 ...
 *   @rnr_offset_x: RNR x offset
 *   @rnr_offset_y: RNR y offset
 *
 *   WNR frame information
 **/
typedef struct  {
  cpp_wnr_plane_t wnr_pl_info[CPP_DENOISE_NUM_PLANES];
  uint32_t rnr_offset_x;
  uint32_t rnr_offset_y;
} cpp_wnr_frame_info_t;
