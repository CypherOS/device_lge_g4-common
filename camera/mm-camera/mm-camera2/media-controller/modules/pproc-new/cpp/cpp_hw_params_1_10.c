  ...
  struct cpp_plane_info_t *plane_info, int32_t plane __unused)
{
  ...
  uint32_t plane_len = (plane_info->input_plane_config.plane_len - 1);
  ...
  struct cpp_plane_info_t *plane_info, int32_t plane)
{
  ...
  int32_t plane_len = (plane_info->output_plane_config.plane_len - 1);
  ...
  if (plane_info->tile_output_enable) {
    CPP_DBG("No MMU prefetch for UBWC");
    return;
  }
