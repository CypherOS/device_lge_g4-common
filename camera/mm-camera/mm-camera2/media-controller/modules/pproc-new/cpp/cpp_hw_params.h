...
#endif
/* Only 5 trigger points are used out of 6 */
#define CPP_PARAM_ASF_TRIGGER_MAX (NUM_GRAY_PATCHES + MAX_LDS_REGIONS)
...
#define CPP_DOWNSCALE_LIMIT_UBWC 10.9f
#define CPP_DOWNSCALE_LIMIT_TNR 6.0f
#define CPP_DOWNSCALE_LIMIT_TNR_UBWC 4.4f
...
typedef struct asf_1_12_rnr_output_t {
  /*radial start positon horizontal*/
  uint32_t rnr_start_offset_h;
  /*radial start positon horizontal*/
  uint32_t rnr_start_offset_v;
  /* radial sqruare LUT*/
...
typedef struct _cpp_params_aec_trigger_params1 {
  float trigger_start[CPP_PARAM_ASF_TRIGGER_MAX];
  float trigger_end[CPP_PARAM_ASF_TRIGGER_MAX];
