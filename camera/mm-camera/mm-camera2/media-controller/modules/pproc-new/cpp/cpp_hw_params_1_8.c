  ...
  uint32_t stripe_num)
{
 ...
 /* Prepare TNR fetch info */
  ...
  CPP_DBG("Debug info for fe_r_info\n");
  ...
  uint32_t stripe_num)
{
  ...
  CPP_DBG("Debug info for we_r_info\n");
