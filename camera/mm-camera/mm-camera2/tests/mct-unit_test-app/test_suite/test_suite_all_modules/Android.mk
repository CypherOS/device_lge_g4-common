...
LIB_NAME := test_suite_all_modules
...
LOCAL_SHARED_LIBRARIES:= libcutils libmmcamera2_mct libmmcamera2_pproc_modules libdl \
  libmmcamera2_isp_modules libmmcamera2_sensor_modules libmmcamera2_iface_modules \
