...
#ifndef TEST_SUITE_NO_SENSOR_H_
#define TEST_SUITE_NO_SENSOR_H_
...
class test_no_sensor : public ITestModule
{
public:
  test_no_sensor(TM_Interface &tmi);
  virtual ~test_no_sensor();
