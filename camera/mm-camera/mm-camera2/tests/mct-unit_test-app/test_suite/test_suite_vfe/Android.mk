...
TEST_C_INCLUDES+= $(LOCAL_MMCAMERA_PATH)/tests/mct-unit_test-app/
TEST_C_INCLUDES+= \
 $(TARGET_DEVICE)/camera/QCamera2/stack/common


LIB_NAME := test_suite_vfe
...
LOCAL_SHARED_LIBRARIES:= libcutils libmmcamera2_mct libdl \
  libmmcamera2_isp_modules libmmcamera2_iface_modules \
  libtm_interface libmmcamera_dbg
